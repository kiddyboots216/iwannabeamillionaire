...
class SMP(object):
    def __init__(self, secret=None):
        self.mod = 2410312003787294341703258437459844288859336526896320919633919
        ...
        if type(secret) is str:
            ...
            self.secret = int(codecs.encode(str.encode(secret), 'hex_codec'), 16)
        elif type(secret) is int:
            self.secret = secret
        else:
